...
class _HomeViewState extends State<HomeView> {
  final List<Category> catego = [
    Category(
      ...
      name: "Ejercicios de Ypga",
    ),
    Category(
      imagUrl: "assets/images/brazo.jpeg",
      name: "Ejercicios Brazos",
    ),
    Category(
      imagUrl: "assets/images/pierna.png",
      name: "Ejercicios Pierna",
    ),

    Category(
      imagUrl: "assets/images/sule.png",
      name: "Ejercicios Gluteos",
    ),
    Category(
      imagUrl: "assets/images/alexsandra.png",
      name: "Ejercicios Peso muerto",
    ),
  ];
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage("assets/images/abdiel.jpg"),
                          fit: BoxFit.cover,
                        ),
                      ),
                    )
